...
public class Equipo1 {
	...
	/**
	 * Constructor parametrizado que recibe como parametro nombre del estadio que
	 * representa el lugar donde se juegan los partidos 
	 * 
	 * @param nombre
	 */
	@Autowired
	...
	/**
	 * Devuelve el nombre del equipo return this nombre
	 */
